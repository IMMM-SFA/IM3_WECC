...
SoC_pd.to_parquet('Outputs/SoC.parquet', index=False)
discharge_pd.to_parquet('Outputs/st_discharge.parquet', index=False)
charge_pd.to_parquet('Outputs/st_charge.parquet', index=False)
