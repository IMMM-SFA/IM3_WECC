...
model.on = Var(model.UC,model.HH_periods, within=NonNegativeReals, initialize=0)

#1 if unit is switching on in hour i, otherwise 0
model.switch = Var(model.UC,model.HH_periods, within=NonNegativeReals,initialize=0)
