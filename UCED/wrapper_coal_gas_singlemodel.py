...
from WECC_MILP_coal_gas_singlemodel import model as m1
from WECC_LP_coal_gas_singlemodel import model as m2
...
for day in range(1,days+1):
    ...
    for z in instance.Gas_below_50:
        for i in K:
            ...
            instance2.HorizonGenLimit[z,i] = instance.HorizonGenLimit[z,i]
    ...
    for z in instance.buses:
        for i in K:
            ...
            instance2.HorizonMustrunLimit[z,i] = instance.HorizonMustrunLimit[z,i]
