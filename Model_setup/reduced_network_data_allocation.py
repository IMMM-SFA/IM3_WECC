...
df_gen = pd.read_csv('../Data_setup/10k_topology_files/10k_Gen.csv',header=0)
        ...
        for UC in UC_TREATMENTS:
            ...
            for T_p in line_limit_MW_scaling:
                ...
                for BA_hurd in BA_hurdle_scaling:
                    ...
                    df_gens = pd.read_csv('../Data_setup/10k_topology_files/10k_Gen.csv',header=0)
                    df_gens = df_gens.replace('', np.nan, regex=True)
                    df_gens_heat_rate = pd.read_excel('../Data_setup/10k_topology_files/NG_Coal_heat_rates.xlsx',header=0)
                    old_bus_num =[]
                    new_bus_num = []
                    NB = []
